use super::{
    ...
    SuggestValueError, Symbol, SymbolType, Term, Variable,
};
...
impl Solver {
    ...
    pub fn add_edit_variable(
        ...
        let strength = super::strength::clip(strength);
        if strength == super::strength::REQUIRED {
    ...
    fn create_row(&mut self, constraint: &Constraint) -> (Box<Row>, Tag) {
        ...
        let tag = match constraint.op() {
            RelationalOperator::GreaterOrEqual | RelationalOperator::LessOrEqual => {
                ...
                if constraint.strength() < super::strength::REQUIRED {
